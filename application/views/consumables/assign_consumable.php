<?php
    $data = array('title'=>'Assign Consumable');
...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Assign Consumable</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <?php
                                        $attributes = array('id'=>'assignConsumableForm');
                                        echo form_open_multipart('consumables/assign_consumable/', $attributes); 
                                    ?>
                                        ...
                                        <div class="form-group">
                                            <label>Date</label>
                                            <input type="date" class="form-control" id="quantiity" name="quantiity" required>
                                        </div>
